  ...
  return (
    <ZentaraLayout>
      ...
      <div className="max-w-4xl mx-auto py-10 px-4">
        <h1 className="text-2xl font-bold mb-6">Tentang Zentara</h1>
        <p className="mb-4">
          ...
          mendalam, dan inspiratif dari berbagai kategori seperti politik, bisnis, teknologi, kesehatan, hiburan, dan lainnya.
        </p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">Nilai-Nilai Kami</h2>
        <ul className="list-disc list-inside mb-4">
          <li><strong>Integritas:</strong> Menyampaikan informasi dengan kejujuran dan tanggung jawab editorial.</li>
          <li><strong>Akurasi:</strong> Mengutamakan fakta dan data yang terverifikasi dalam setiap publikasi.</li>
          <li><strong>Profesionalisme:</strong> Dikelola oleh tim yang berdedikasi dan berpengalaman di bidang jurnalistik serta teknologi media.</li>
          <li><strong>Kebebasan Pers:</strong> Menjaga independensi pemberitaan dari pengaruh politik atau kepentingan komersial.</li>
        </ul>

        <h2 className="text-xl font-semibold mt-6 mb-2">Tim Kami</h2>
        <p className="mb-4">
        ...
        <p>
          ...
          melalui akun media sosial resmi kami. Kami selalu terbuka untuk menjalin komunikasi dengan pembaca.
        </p>
      </div>
    </ZentaraLayout>
  );
